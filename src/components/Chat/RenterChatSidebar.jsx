  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      ...
      snapshot.forEach((doc) => {
        const data = doc.data();
        // Fix the filtering logic - check for both carRole and recipientId
        ...
        {chatRooms.length === 0 ? (
          <div className="h-full flex items-center justify-center p-4 sm:p-6 lg:p-8 xl:p-10 text-center text-gray-500">
            <div>
              ...
              <p className="text-sm sm:text-base lg:text-lg mb-2 font-medium">No rental inquiries yet</p>
          ...
          <div className="min-h-full">
            {chatRooms.map((room) => (
              <div
                ...
                } ${room.unreadByRenter ? "bg-blue-25 font-medium shadow-sm" : ""}`}
